  ...
  const formatPrice = (
    ...
    return isRTL
      ? `${currency}${maxNum.toLocaleString(
          "he-IL"
        )} - ${currency}${minNum.toLocaleString("he-IL")}`
      : `${currency}${minNum.toLocaleString(
          "he-IL"
        )} - ${currency}${maxNum.toLocaleString("he-IL")}`;
  };
  ...
  const translateJourneyTitle = (title: string) => {
    const titleTranslations: Record<string, { he: string; en: string }> = {
      "Classic Japan Circuit": {
        he: "מסע יפן הקלאסי",
        en: "Classic Japan Circuit",
      },
      "European Highlights Tour": {
        he: "סיור דגשי אירופה",
        en: "European Highlights Tour",
      },
      "European Capital Tour": {
        he: "סיור בירות אירופה",
        en: "European Capital Tour",
      },
      "Southeast Asia Adventure": {
        he: "הרפתקה בדרום מזרח אסיה",
        en: "Southeast Asia Adventure",
      },
      "Mediterranean Dream": {
        he: "חלום ים תיכוני",
        en: "Mediterranean Dream",
      },
      "East Coast USA Explorer": {
        he: 'סיור החוף המזרחי של ארה"ב',
        en: "East Coast USA Explorer",
      },
      "Japan Extended Discovery": {
        he: "לחקור את יפן המורחבת",
        en: "Japan Extended Discovery",
      },
      "Grand European Journey": {
        he: "מסע אירופי גדול",
        en: "Grand European Journey",
      },
      "Southeast Asia Multi-Country": {
        he: "הרפתקה בדרום מזרח אסיה (מרובת מדינות)",
        en: "Southeast Asia Multi-Country",
      },
    };
      ...
      <div className="bg-gradient-to-r from-orange-500 to-teal-500 text-white py-12 px-4">
        <div className={`max-w-7xl mx-auto ${isRTL ? "text-right" : ""}`}>
          ...
          <div className={`flex ${isRTL ? "justify-end" : "justify-start"}`}>
            ...
            >
              {isRTL
                ? "גלה מסלולי טיול מושלמים עם מספר יעדים"
                : "Discover perfect travel routes across multiple destinations"}
            </p>
          </div>
        </div>
      </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-4 gap-6">
              ...
              <div>
                ...
                >
                  ...
                  >
                    <SelectValue
                      placeholder={isRTL ? "כל העונות" : "All Seasons"}
                    />
                  </SelectTrigger>
              ...
              <div className="md:col-span-2">
                ...
                >
                  ...
                  {(() => {
                    const currency = isRTL ? "₪" : "$";
                    const minNum = isRTL
                      ? Math.round(filters.minBudget * 3.5)
                      : filters.minBudget;
                    const maxNum = isRTL
                      ? Math.round(filters.maxBudget * 3.5)
                      : filters.maxBudget;
                    return isRTL
                      ? `${currency}${maxNum.toLocaleString(
                          "he-IL"
              ...
              >
                ...
                >
                  {journeys.length}{" "}
                  {isRTL ? "מסעות זמינים" : "journeys available"}
                </span>
              </div>
            </div>
                ...
                <Card className="h-full w-full flex flex-col overflow-hidden hover:shadow-xl transition-shadow cursor-pointer group">
                  <div className="relative h-48 overflow-hidden">
                    ...
                    <div
                      ...
                      } bg-white/90 backdrop-blur-sm px-3 py-1 rounded-full flex items-center gap-1`}
                    >
                  ...
                  <CardContent className="p-6 flex-1 flex flex-col">
                    ...
                    >
                      ...
                      >
                        ...
                        >
                          {isRTL ? (
                            <span className="w-4 h-4 font-bold flex items-center justify-center text-gray-700">
                              ₪
                            </span>
                          ) : (
                        ...
                        >
                          {isRTL
                            ? "כולל: מלונות, טיסות, אטרקציות"
                            : "Includes: Hotels, Flights, Attractions"}
                        </span>
                      </div>
                    </div>
