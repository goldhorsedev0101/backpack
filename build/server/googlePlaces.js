...
export class GooglePlacesService {
    ...
    async searchPlaces(query, type, location) {
        try {
    ...
    async importAccommodation(placeResult, destinationId) {
    ...
    async importRestaurant(placeResult, destinationId) {
        const details = await this.getPlaceDetails(placeResult.place_id);
        if (!details)
            return null;
    ...
    async importAttraction(placeResult, destinationId) {
        const details = await this.getPlaceDetails(placeResult.place_id);
        if (!details)
            return null;
    ...
    async importReviews(placeId, category) {
